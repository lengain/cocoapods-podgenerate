  Pod::Spec.new do |s|
    s.name             = 'PodGen_113'
    s.version          = '1.0.0'
    s.summary          = 'PodGen_113 - [HighBusiness] 高层业务模块，编排多个中层组件实现完整业务场景'
    s.description      = <<-DESC
        PodGen_113 is a auto-generated test pod for CocoaPods performance benchmarking.
        Layer: HighBusiness. 高层业务模块，编排多个中层组件实现完整业务场景
    DESC
    s.homepage         = 'https://github.com/example/PodGen_113'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'Example' => 'example@example.com' }
    s.source           = { :git => 'https://github.com/example/PodGen_113.git', :tag => s.version.to_s }
    ...
    s.resource_bundles = {
      'PodGen_113Resources' => ['Assets/**/*', 'Resources/**/*']
    }
