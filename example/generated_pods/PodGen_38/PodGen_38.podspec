  Pod::Spec.new do |s|
    s.name             = 'PodGen_38'
    s.version          = '1.0.0'
    s.summary          = 'PodGen_38 - [MidComponent] 中层功能组件，组合底层库实现特定业务能力'
    s.description      = <<-DESC
        PodGen_38 is a auto-generated test pod for CocoaPods performance benchmarking.
        Layer: MidComponent. 中层功能组件，组合底层库实现特定业务能力
    DESC
    s.homepage         = 'https://github.com/example/PodGen_38'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'Example' => 'example@example.com' }
    s.source           = { :git => 'https://github.com/example/PodGen_38.git', :tag => s.version.to_s }
    ...
    s.resource_bundles = {
      'PodGen_38Resources' => ['Assets/**/*', 'Resources/**/*']
    }
